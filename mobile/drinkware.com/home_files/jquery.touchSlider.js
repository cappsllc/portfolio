...
(function($) {
  ...
  $.fn.touchSlider = function(options){
    ...
    this.each(function() {
	  ...
	  var dTime = new Date();
		var hours = parseInt(dTime.getHours());
		var selectedIndex = 0;
		/* if 6am-6pm select day
		else (6pm-6am) select night*/
		//if (dTime.getHours() > 6 && dTime.getHours() < 18) // test
		if (hours <= 6) {
			selectedIndex = 1; 
		}
		if( hours >= 18){
      ...
      setCurrentOffset(selectedIndex);
